    ...
    S.PhoneGapRemoteStorage = function ($q, phoneGap) {
        function uploadFile(options) {
            ...
            try {
                ...
                fileUploadOptions.fileName = "new.jpg";// options.fileName;
                ...
                fileTransfer.upload(options.localUrl,encodeURI(options.remoteUrl), onSuccess, onFailure, fileUploadOptions, true);
            } catch (e) {
                console.log("Error", e);
            }
