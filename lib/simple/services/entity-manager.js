(function (S) {
    ...
    S.EntityManager = ["$rootScope", "$q", "configurationManager", "loginManager", function ($rootScope, $q, configurationManager, loginManager) {
        var manager = null;
        function getEntityManager() {
            ...
            if (!manager) {
                loginManager.getAccessToken().then(function (token) {
                    ...
                    manager = new breeze.EntityManager(serverAddress);
                    resolve();
                });
            } else {
                resolve();
